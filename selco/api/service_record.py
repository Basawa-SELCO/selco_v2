...
def get_service_record():
	...
	data_list = []
	parent_fields = ['name','selco_complaint_date','docstatus','selco_customer_feedback','selco_service_charge_collected','selco_total_component_charges_collected','selco_total_amount','selco_detail_address','selco_customer_address','selco_customer_remarks','selco_customer_signature','selco_customer_date','selco_landline_mobile_2','selco_cse_location','selco_branch','selco_posting_date','selco_cse_feedback','selco_job_status','selco_cse_name','selco_customer_contact_number','selco_signature_of_the_cse','selco_cse_signature','selco_signature_of_the_customer','selco_customer_id','selco_cse_remarks','selco_complaint_number','selco_cse_date','selco_customer_full_name','selco_type_of_service_attended']
