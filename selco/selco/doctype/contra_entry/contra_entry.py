...
class ContraEntry(Document):
		def before_insert(self):
			frappe.msgprint('jkl')
			self.naming_series = frappe.db.get_value("Branch",self.selco_branch,"contra_naming_series")
		...
		def on_submit(self):
			...
			je.name = "J" + self.name
			je.naming_series = "J" + frappe.db.get_value("Branch",self.selco_branch,"contra_naming_series")
